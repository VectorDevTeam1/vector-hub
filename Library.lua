...
function TDS:RunStrategy()
    ...
    Globals.activeStrategyThread = task.spawn(function()
        ...
        pcall(function()
            loadstring(readfile(GetStratFile()))()
        end)
...
function TDS:Mode(difficulty, code)
    ...
    Globals.ActiveStrategy = difficulty
    getgenv().ActiveStrategy = difficulty
    SetSetting("ActiveStrategy", difficulty)
    local targetCode = ""
